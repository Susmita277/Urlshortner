...
@section('content')
    <div class="w-full text-center px-20 relative  py-24 bg-[url('https://bit.ly/3UVV4zo')]">
        <p class=" font-bold text-primary-color text-2xl">SHORTEN YOUR URLs </p>
    ...
    <div class=" absolute top-96 w-full flex justify-center items-center pb-20">
        <div class=" bg-body-color  rounded-md w-2/3 p-20 h-fit text-center ">
            ...
            <form action="{{route('url.store')}}" method="POST" class="flex justify-between">
                @csrf
